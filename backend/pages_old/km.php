...
?>
                                        ...
                                        foreach ($itemsList as $item) {
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="text-align: center" nowrap>
                                                    <form method="post" action="km_add_edit.php">
    ...
    <script>
        ...
        function onClickAdd() {
            window.location.href = 'km_add_edit.php';
        }

        function onClickDelete(element, documentsId, itemName) {
            BootstrapDialog.show({
                title: 'ลบKM',
                message: 'ยืนยันลบKM \'' + itemName + '\' ?',
                buttons: [{
                    label: 'ลบ',
                    action: function (self) {
                        doDeleteDocument(documentsId);
                        self.close();
                    },
        ...
        function doDeleteDocument(documentsId) {
            $.post(
                '../api/api.php/delete_document',
                {
                    id: documentsId,
                }
            ).done(function (data) {
