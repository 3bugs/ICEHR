    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <?php echo(isset($itemId) ? 'แก้ไข' : 'เพิ่ม'); ?>KM
                    <small>KM</small>
                </h1>
            </section>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    <h3 class="box-title">รายละเอียดKM</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="inputArticle">ชื่อKM:</label>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#formAddDocument").validate({
                ...
                messages: {
                    title: {
                    required: "ต้องระบุชื่อKM",
                    minlength: "ชื่อKM ควรมีความยาวอยู่ระหว่าง 3-50 ตัวอักษร"
                    }
                },
        ...
        function doAddDocument() {
            ...
            success: function (data) {
                ...
                if (data.error_code === 0) {
                    ...
                    BootstrapDialog.show({
                        title: '<?php echo(isset($itemId) ? 'แก้ไขKM' : 'เพิ่มKM'); ?>',
                        message: data.error_message,
                        buttons: [{
                            label: 'ปิด',
                            action: function (self) {
                    ...
                    BootstrapDialog.show({
                        title: '<?php echo(isset($itemId) ? 'แก้ไขKM' : 'เพิ่มKM'); ?> - ผิดพลาด',
                        message: data.error_message,
                        buttons: [{
                            label: 'ปิด',
                            action: function (self) {
