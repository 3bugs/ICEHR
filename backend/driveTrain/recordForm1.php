...
?>
    ...
    <table width="700px" align="center" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td align="center" style="font-size: 30px; height: 60px;"><strong>บันทึกผลการอบรมรายบุคคล</strong></td>
        </tr>
        ...
        <tr>
            <td>
                <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="250px" align="right">ชื่อสถาบันการศึกษา</td>
                        <td width="450px" class="txtDash">สถาบันเสริมศึกษาและทรัพยากรมนุษย์ มหาวิทยาลัยธรรมศาสตร์</td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top:5px;">
                    ...
                    ?>
                    <tr>
                        <td width="125px">ชื่อผู้เข้ารับการอบรม</td>
                        <td width="232px" class="txtDash"><?= "{$trainee['title']}{$trainee['first_name']} {$trainee['last_name']}"; ?></td>
                        <td width="173px">เลขที่บัตรประจำตัวประชาชน</td>
                        <td class="txtDash" width="170px"><?= thaiNumDigit($formatPid); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top:5px;">
                    <tr>
                        ...
                        <td width="640px" class="txtDash">"การอบรมสำหรับผู้ขอรับใบอนุญาตขับรถ"</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top:5px;">
                    <tr>
                        ...
                        ?>
                        <td width="150px">สำหรับประเภทใบอนุญาต</td>
        ...
        <tr>
            <td>
                <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top:5px;">
                    <tr>
                        <td width="60px">วันที่อบรม</td>
                        <td width="640px" class="txtDash">
        ...
        <tr>
            <td>
                <table width="700px" align="center" border="1px" cellpadding="0" cellspacing="0" style="padding-top: 5px; margin-top: 10px; border-collapse: collapse; font-size: 13pt;">
                    <tr>
                    ...
                    foreach ($subjectList as $subject) {
                        ?>
                        <tr>
                            <td align="center" style="height:40px;"><?= getThaiShortDate(date_create($trainee['begin_date'])); ?></td>
                            ...
                            <td align="center"><img src="../images/driveTrain/correct.png"/></td>
                            <td align="center">---</td>
                            <td align="center"></td>
                            <td>
    ...
    <table width="700px" align="center" border="1" cellpadding="0" cellspacing="0" style="margin-top: 30px;">
        <tr>
            <td width="350px"></td>
