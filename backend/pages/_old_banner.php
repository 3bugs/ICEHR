...
$sql = "SELECT a.id,a.name,a.status,a.created_at,a.created_by,u.username "
    . " FROM banners a INNER JOIN user u ON a.created_by = u.id "
...
?>
                                        ...
                                        foreach ($itemsList as $item) {
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="text-align: center" nowrap>
                                                    <form method="post" action="banner_add_edit.php">
    ...
    <script>
        ...
        function onClickAdd() {
            window.location.href = 'banner_add_edit.php';
        }

        function onClickDelete(element, bannerId, itemName) {
            BootstrapDialog.show({
                title: 'ลบแบนเนอร์',
                message: 'ยืนยันลบแบนเนอร์ \'' + itemName + '\' ?',
                buttons: [{
                    label: 'ลบ',
