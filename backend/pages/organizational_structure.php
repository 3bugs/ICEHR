...
$sql = "SELECT a.id,a.title,a.status,a.created_at,a.created_by,u.username "
    ...
    . " WHERE a.page_layout ='organizational_structure' "
...
?>
                                        ...
                                        foreach ($itemsList as $item) {
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="text-align: center" nowrap>
                                                    <form method="post" action="organizational_structure_add_edit.php">
    ...
    <script>
        ...
        function onClickAdd() {
            window.location.href = 'organizational_structure_add_edit.php';
        }

        function onClickDelete(element, articleId, itemName) {
            BootstrapDialog.show({
                title: 'ลบโครงสร้างองค์กร',
                message: 'ยืนยันลบโครงสร้างองค์กร \'' + itemName + '\' ?',
                buttons: [{
                    label: 'ลบ',
        ...
        function doDeleteArticle(articleId) {
            $.post(
                ...
                if (data.error_code === 0) {
                    ...
                    BootstrapDialog.show({
                        title: 'ลบโครงสร้างองค์กร - ผิดพลาด',
