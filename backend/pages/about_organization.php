...
$sql = "SELECT a.id,a.title,a.status,a.created_at,a.created_by,u.username "
    ...
    . " WHERE a.page_layout ='about_organization' "
...
?>
                                        ...
                                        foreach ($itemsList as $item) {
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="text-align: center" nowrap>
                                                    <form method="post" action="about_organization_add_edit.php">
    ...
    <script>
        ...
        function onClickAdd() {
            window.location.href = 'about_organization_add_edit.php';
        }

        function onClickDelete(element, articleId, itemName) {
            BootstrapDialog.show({
                title: 'ลบเกี่ยวกับองค์กร',
                message: 'ยืนยันลบเกี่ยวกับองค์กร \'' + itemName + '\' ?',
                buttons: [{
                    label: 'ลบ',
        ...
        function doDeleteArticle(articleId) {
            $.post(
                ...
                if (data.error_code === 0) {
                    ...
                    BootstrapDialog.show({
                        title: 'ลบเกี่ยวกับองค์กร - ผิดพลาด',
