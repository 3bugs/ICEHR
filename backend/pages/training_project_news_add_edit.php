...
if (isset($itemId)) {
    ...
    /* Media Cover */
    $sql_media_cover = "SELECT * FROM media WHERE model_id=$itemId AND collection_name ='cover_desktop'";    
    ...
    /* Media Gallery */
    $sql_media_gallery = "SELECT * FROM media WHERE model_id=$itemId AND collection_name ='gallery_desktop'";    
