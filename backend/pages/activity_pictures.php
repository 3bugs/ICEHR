...
?>
                                        ...
                                        foreach ($itemsList as $item) {
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="text-align: center" nowrap>
                                                    <form method="post" action="activity_pictures_add_edit.php">
    ...
    <script>
        ...
        function onClickAdd() {
            window.location.href = 'activity_pictures_add_edit.php';
        }

        function onClickDelete(element, articleId, itemName) {
            BootstrapDialog.show({
                title: 'ลบภาพกิจกรรม',
                message: 'ยืนยันลบภาพกิจกรรม \'' + itemName + '\' ?',
                buttons: [{
                    label: 'ลบ',
