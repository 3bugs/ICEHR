                  ...
                  <div class="input-group">
                    ...
                    <select id="selectCourseCategory" class="form-control"
                      ...
                      foreach ($trainingCourseCategoryList as $trainingCourseCategory) {
                        ?>
                        <option value="<?= $trainingCourseCategory['id']; ?>">
                          <?= $trainingCourseCategory['title']; ?>
                        </option>
                        <?php
                      }
                      ?>
                ...
                <table id="tableCourseMaster" class="table table-bordered table-striped">
                  ...
                  if (sizeof($courseMasterList) == 0) {
                    ...
                    foreach ($courseMasterList as $courseMaster) {
                      ...
                      ?>
                      <tr style="">
                        <td style=""><?= $courseMasterTitle; ?></td>
                        <?php
                        if ($serviceType === SERVICE_TYPE_TRAINING) {
                          ?>
                          <td style=""><?= $courseMasterCategoryTitle; ?></td>
                          <?php
                        }
                        ?>
                        <td style="text-align: center" nowrap>
                          ...
                          if (($serviceType === SERVICE_TYPE_TRAINING && currentUserHasPermission(PERMISSION_COURSE_TRAINING_MANAGE_COURSE_MASTER))
                            ...
                            <button type="button" class="btn btn-warning"
                                    ...
                                    onclick="onClickEdit(this, <?= $courseMasterId; ?>, '<?= htmlspecialchars($courseMasterTitle); ?>', <?= $courseMasterCategoryId; ?>)">
                            ...
                            if ($serviceType !== SERVICE_TYPE_DRIVING_LICENSE) {
                              ...
                              <button type="button" class="btn btn-danger"
                                      ...
                                      onclick="onClickDelete(this, <?= $courseMasterId; ?>, '<?= htmlspecialchars($courseMasterTitle); ?>')">
