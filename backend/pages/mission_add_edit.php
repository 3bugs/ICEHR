...
if (isset($itemId)) {
    ...
    /* Media Cover */
    $sql_media_cover = "SELECT * FROM media WHERE model_id=$itemId AND collection_name ='cover_desktop' AND model_type='mission'";    
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <?php echo(isset($itemId) ? 'แก้ไข' : 'เพิ่ม'); ?>ภารกิจ
                    <small>ภารกิจ</small>
                </h1>
            </section>
            ...
            <section class="content">
                <form id="formAddMission" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    <h3 class="box-title">รายละเอียดภารกิจ</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="inputArticle">ชื่อภารกิจ:</label>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#formAddMission").validate({
                ...
                messages: {
                    title: {
                    required: "ต้องระบุชื่อภารกิจ",
                    minlength: "ชื่อภารกิจ ควรมีความยาวอยู่ระหว่าง 3-50 ตัวอักษร"
                    }
                },
        ...
        function doAddMission() {
            ...
            url: '../api/api.php/<?php echo(isset($itemId) ? 'update_mission' : 'add_mission'); ?>',
            data: data,
            processData: false,
            contentType: false,
            cache: false,
            ...
            success: function (data) {
                ...
                if (data.error_code === 0) {
                    ...
                    BootstrapDialog.show({
                        title: '<?php echo(isset($itemId) ? 'แก้ไขภารกิจ' : 'เพิ่มภารกิจ'); ?>',
                        message: data.error_message,
                        buttons: [{
                            label: 'ปิด',
                            action: function (self) {
                    ...
                    BootstrapDialog.show({
                        title: '<?php echo(isset($itemId) ? 'แก้ไขภารกิจ' : 'เพิ่มภารกิจ'); ?> - ผิดพลาด',
                        message: data.error_message,
                        buttons: [{
                            label: 'ปิด',
                            action: function (self) {
