...
?>
    ...
    foreach ($traineeList as $trainee) {
        ...
        if (((int)$trainee['license_type'] & 1) === 1) {
            ?>
                        ...
                        <td>
                            <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top: 15px;">
                                <tr>
                                    ...
                                    <td width="210px">
                                        <?= (((int)$trainee['license_type'] & 2) === 2) ? '<img src="../images/driveTrain/unchecked.png">' : '<img src="../images/driveTrain/unchecked.png">'; ?>
                                        <font size="-1">&nbsp;รถจักรยานยนต์ส่วนบุคคล<?= (int)$trainee['course_type'] === 1 ? 'ชั่วคราว' : ''; ?></font>
                                    </td>
                                    <td width="180px">
                                        <?= (((int)$trainee['license_type'] & 4) === 4) ? '<img src="../images/driveTrain/unchecked.png">' : '<img src="../images/driveTrain/unchecked.png">'; ?>
        ...
        if (((int)$trainee['license_type'] & 2) === 2) {
            ?>
            <div <?= ($i++ !== 0) ? 'style="page-break-before: always"' : ''; ?>>
                <table width="700px" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top: 15px;">
                                <tr>
                                    <td width="145px">ประเภทใบอนุญาตขับรถ</td>
                                    <td width="165px">
                                        <?= (((int)$trainee['license_type'] & 1) === 1) ? '<img src="../images/driveTrain/unchecked.png">' : '<img src="../images/driveTrain/unchecked.png">'; ?>
                                        <font size="-1">&nbsp;รถยนต์ส่วนบุคคล<?= (int)$trainee['course_type'] === 1 ? 'ชั่วคราว' : ''; ?></font>
                                    </td>
                                    <td width="210px">
        ...
        if (((int)$trainee['license_type'] & 4) === 4) {
            ?>
            <div <?= ($i++ !== 0) ? 'style="page-break-before: always"' : ''; ?>>
                <table width="700px" align="center" border="0" cellspacing="0" cellpadding="0">
                    <tr>
