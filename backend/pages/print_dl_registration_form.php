          ...
          <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td align="center" width="150px" class="txtDash">
                <strong><?= $trainee == null ? '' : thaiNumDigit(getThaiShortDateFullYear(date_create($trainee['created_at'])), $isThaiDigit); ?></strong>
              </td>
            </tr>
          </table>
        </td>
        ...
        <td>
          <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top: 15px;">
            <tr>
              ...
              <td width="580px" class="txtDash"><strong><?= $trainee == null ? '' : thaiNumDigit(getThaiShortDate(date_create($trainee['course_date'])), $isThaiDigit); ?></strong></td>
            </tr>
          </table>
        </td>
      </tr>
        ...
        <td>
          <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top: 50px;">
            ...
            <tr>
              ...
              ?>
              <td align="center">( <?= $trainee == null ? $spaces : "{$trainee['title']}{$trainee['first_name']}&nbsp;{$trainee['last_name']}"; ?> )</td>
            </tr>
          </table>
          <table width="700px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top: 15px;">
            <tr>
        ...
        <td>
          <table width="650px" align="center" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td align="center" width="170px" class="txtDash" style="padding-left: 0">
                <strong><?= $trainee == null ? '' : thaiNumDigit(getThaiShortDate(date_create($trainee['created_at'])), false); ?></strong>
              </td>
            </tr>
          </table>
        </td>
        ...
        <td>
          <table width="650px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top: 5px;">
            <tr>
              <td width="120px">วัน/เดือน/ปี ที่อบรม</td>
              <td width="530px" class="txtDash">
                <strong><?= $trainee == null ? '' : thaiNumDigit(getThaiShortDate(date_create($trainee['course_date'])), false); ?></strong>
              </td>
            </tr>
          </table>
        </td>
          ...
          <table width="650px" align="center" border="0" cellpadding="0" cellspacing="0" style="padding-top: 5px;">
            <tr>
              ...
              <td width="470px" class="txtDash">
                <strong><?= $trainee == null ? '' : thaiNumDigit("{$trainee['responsible_user_first_name']} {$trainee['responsible_user_last_name']}, โทร. {$trainee['responsible_user_phone_office']}, อีเมล {$trainee['responsible_user_email']}", false); ?></strong>
              </td>
            </tr>
          </table>
        </td>
