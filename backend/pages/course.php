...
$sql = "SELECT c.id, c.batch_number, c.details, c.begin_date, c.end_date, c.application_fee, 
               c.place, c.trainee_limit, c.responsible_user_id, c.status, c.is_online, cm.title 
        FROM course c 
              ...
              <table id="tableCourse" class="table table-bordered table-striped">
                ...
                if (sizeof($courseList) == 0) {
                  ...
                  foreach ($courseList as $course) {
                    ...
                    <tr style="">
                      <td style="vertical-align: top"><?= $courseName; ?>&nbsp;<?= $isOnline ? '<small class="label bg-red"><i class="fa fa-play-circle"></i>&nbsp;อบรมออนไลน์</small>' : ''; ?>&nbsp;
