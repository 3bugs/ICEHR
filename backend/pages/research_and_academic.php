...
$sql = "SELECT a.id,a.title,a.status,a.created_at,a.created_by,u.username "
    . " FROM research_and_academic a INNER JOIN user u ON a.created_by = u.id "
...
?>
                                        ...
                                        foreach ($itemsList as $item) {
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="text-align: center" nowrap>
                                                    <form method="post" action="research_and_academic_add_edit.php">
    ...
    <script>
        ...
        function onClickAdd() {
            window.location.href = 'research_and_academic_add_edit.php';
        }

        function onClickDelete(element, articleId, itemName) {
            BootstrapDialog.show({
                title: 'ลบโครงการวิจัยและวิชาการ',
                message: 'ยืนยันลบโครงการวิจัยและวิชาการ \'' + itemName + '\' ?',
                buttons: [{
                    label: 'ลบ',
        ...
        function doDeleteArticle(articleId) {
            $.post(
                ...
                if (data.error_code === 0) {
                    ...
                    BootstrapDialog.show({
                        title: 'ลบโครงการวิจัยและวิชาการ - ผิดพลาด',
