...
?>
                                        ...
                                        foreach ($itemsList as $item) {
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="text-align: center" nowrap>
                                                    <form method="post" action="top_menu_add_edit.php">
                                            ...
                                            <?php
                                                ...
                                                if($count_parent_id >0){
                                                    $sql_level2 = "SELECT  a.id,
                                                            ...
                                                            "
                                                        . " FROM menus a INNER JOIN user u ON a.created_by = u.id "
                                                        . " WHERE a.position ='header' AND parent_id ='$itemId'"
                                                        . " ORDER BY a.ordering ASC";
    ...
    <script>
        ...
        function onClickAdd() {
            window.location.href = 'top_menu_add_edit.php';
        }

        function onClickDelete(element, menuId, itemName) {
            BootstrapDialog.show({
                title: 'ลบเมนูด้านบน',
                message: 'ยืนยันลบเมนูด้านบน \'' + itemName + '\' ?',
                buttons: [{
                    label: 'ลบ',
