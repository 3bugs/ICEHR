...
?>
                                        ...
                                        foreach ($itemsList as $item) {
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="text-align: center" nowrap>
                                                    <form method="post" action="footer_menu_center_add_edit.php">
                                            ...
                                            <?php
                                                ...
                                                if($count_parent_id >0){
                                                    $sql_level2 = "SELECT  a.id,
                                                            ...
                                                            "
                                                        . " FROM menus a INNER JOIN user u ON a.created_by = u.id "
                                                        . " WHERE a.position ='footer-center' AND parent_id ='$itemId'"
                                                        . " ORDER BY a.ordering ASC";
    ...
    <script>
        ...
        function onClickAdd() {
            window.location.href = 'footer_menu_center_add_edit.php';
        }

        function onClickDelete(element, menuId, itemName) {
            BootstrapDialog.show({
                title: 'ลบเมนูส่วนท้าย ตำแหน่งกลาง',
                message: 'ยืนยันลบเมนูส่วนท้าย ตำแหน่งกลาง \'' + itemName + '\' ?',
                buttons: [{
                    label: 'ลบ',
        ...
        function doDeleteMenu(menuId) {
            $.post(
                ...
                if (data.error_code === 0) {
                    ...
                    BootstrapDialog.show({
                        title: 'ลบเมนูส่วนท้าย ตำแหน่งกลาง - ผิดพลาด',
