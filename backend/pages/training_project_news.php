...
$sql = "SELECT a.id,a.title,a.status,a.created_at,a.created_by,u.username "
    ...
    . " WHERE a.page_layout ='training_project_news' "
...
?>
                                        ...
                                        foreach ($itemsList as $item) {
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="text-align: center" nowrap>
                                                    <form method="post" action="training_project_news_add_edit.php">
    ...
    <script>
        ...
        function onClickAdd() {
            window.location.href = 'training_project_news_add_edit.php';
        }

        function onClickDelete(element, articleId, itemName) {
            BootstrapDialog.show({
                title: 'ลบข่าวโครงการฝึกอบรม',
                message: 'ยืนยันลบข่าวโครงการฝึกอบรม \'' + itemName + '\' ?',
                buttons: [{
                    label: 'ลบ',
        ...
        function doDeleteArticle(articleId) {
            $.post(
                ...
                if (data.error_code === 0) {
                    ...
                    BootstrapDialog.show({
                        title: 'ลบข่าวโครงการฝึกอบรม - ผิดพลาด',
