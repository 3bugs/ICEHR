                                        ...
                                        if (!empty($item)) {
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane" id="cover_image_tab_2" style="padding: 0px">
                                                        <ul style="color: orangered; margin-top: 10px; margin-bottom: 15px">
                                                            ...
                                                            if ($type === TYPE_BANNER) {
                                                                ?>
                                                                <li style="margin-bottom: 10px">ภาพแบนเนอร์ ให้ใช้ภาพ JPG ขนาด 1000x500 (กว้าง 1,000 pixel สูง 500 pixel)
                                                                    หรือขนาดอื่นที่มีอัตราส่วนความกว้าง:ความสูง = 2:1 เช่น 800x400 แต่ไม่ควรมีขนาดเล็กเกินไป (ภาพจะไม่คมชัด) หรือใหญ่เกินไป
                                                                    (จะใช้เวลาโหลดภาพนาน)
                                                                </li>
                                                                <?php
                                                            } else if ($type === TYPE_MISSION) {
                                                                ?>
                                                                <li style="margin-bottom: 10px">ให้ใช้ภาพ JPG ขนาด 600x312 pixel (กว้าง 600 pixel, สูง 312 pixel)</li>
                                                                <?php
                                                            }
                                                            ?>
                                            ...
                                            <ul style="color: orangered; margin-top: 10px; margin-bottom: 15px">
                                                ...
                                                if ($type === TYPE_BANNER) {
                                                    ?>
                                                    <li style="margin-bottom: 10px">ภาพแบนเนอร์ ให้ใช้ภาพ JPG ขนาด 1000x500 (กว้าง 1,000 pixel สูง 500 pixel)
                                                        หรือขนาดอื่นที่มีอัตราส่วนความกว้าง:ความสูง = 2:1 เช่น 800x400 แต่ไม่ควรมีขนาดเล็กเกินไป (ภาพจะไม่คมชัด) หรือใหญ่เกินไป (จะใช้เวลาโหลดภาพนาน)
                                                    </li>
                                                    <?php
                                                } else if ($type === TYPE_MISSION) {
                                                    ?>
