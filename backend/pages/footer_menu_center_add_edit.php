    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <?php echo(isset($itemId) ? 'แก้ไข' : 'เพิ่ม'); ?>เมนูส่วนท้าย ตำแหน่งกลาง
                    <small>เมนูส่วนท้าย ตำแหน่งกลาง</small>
                </h1>
            </section>
                ...
                <form id="formMenu" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <!--รายละเอียดเมนูส่วนท้าย ตำแหน่งกลาง-->
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    <h3 class="box-title">รายละเอียดเมนูส่วนท้าย ตำแหน่งกลาง</h3>
                                ...
                                <div class="box-body">
                                    ...
                                    <!--ชื่อเมนูส่วนท้าย ตำแหน่งกลาง-->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="inputArticle">ชื่อเมนูส่วนท้าย ตำแหน่งกลาง:</label>
                                                        ...
                                                        <?php
                                                            $sql = "SELECT  a.id,
                                                                ...
                                                                (SELECT count(id) FROM menus AS b WHERE b.parent_id = a.id) AS count_parent_id
                                                                  "
                                                                . " FROM menus a "
                                                                . " WHERE a.position ='footer-center' AND parent_id ='0'"
                                                                ...
                                                                <?php
                                                                    ...
                                                                    if($count_parent_id >0){
                                                                        $sql_level2 = "SELECT   a.id,
                                                                                        ...
                                                                                        "
                                                                                    . " FROM menus a"
                                                                                    . " WHERE a.position ='footer-center' AND parent_id ='$itemId_level1'"
                                                                                    . " ORDER BY a.ordering ASC";
                                                                ...
                                                                ?>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            if($count_parent_id_level2 >0){
                                                                                ...
                                                                                "
                                                                                    . " FROM menus a"
                                                                                    . " WHERE a.position ='footer-center' AND parent_id ='$itemId_level2'"
                                                                                    . " ORDER BY a.ordering ASC";
        ...
        <input name="position" type="hidden" value="footer-center">
        <?php 
            if(isset($itemId)):
        ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#formMenu").validate({
                ...
                messages: {
                    title: {
                    required: "ต้องระบุชื่อเมนูส่วนท้าย ตำแหน่งกลาง",
                    minlength: "ชื่อเมนูส่วนท้าย ตำแหน่งกลาง ควรมีความยาวอยู่ระหว่าง 3-50 ตัวอักษร"
                    }
                },
                    ...
                    success: function (data) {
                        ...
                        if (data.error_code === 0) {
                            ...
                            BootstrapDialog.show({
                                title: 'เมนูส่วนท้าย ตำแหน่งกลาง',
                            ...
                            BootstrapDialog.show({
                                title: 'เมนูส่วนท้าย ตำแหน่งกลาง - ผิดพลาด',
                                message: data.error_message,
                                buttons: [{
                                    label: 'ปิด',
                                    action: function (self) {
        ...
        function doAddMenu() {
            ...
            success: function (data) {
                ...
                if (data.error_code === 0) {
                    ...
                    BootstrapDialog.show({
                        title: '<?php echo(isset($itemId) ? 'แก้ไขเมนูส่วนท้าย ตำแหน่งกลาง' : 'เพิ่มเมนูส่วนท้าย ตำแหน่งกลาง'); ?>',
                        message: data.error_message,
                        buttons: [{
                            label: 'ปิด',
                            action: function (self) {
                    ...
                    window.location.href = 'footer_menu_center.php';

                } else {

                    BootstrapDialog.show({
                        title: '<?php echo(isset($itemId) ? 'แก้ไขเมนูส่วนท้าย ตำแหน่งกลาง' : 'เพิ่มเมนูส่วนท้าย ตำแหน่งกลาง'); ?> - ผิดพลาด',
                        message: data.error_message,
                        buttons: [{
                            label: 'ปิด',
                            action: function (self) {
