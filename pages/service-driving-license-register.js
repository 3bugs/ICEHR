                  ...
                  <div className="row">
                    <div className="col-12">
                      ...
                      <div className="row">
                        ...
                        <div
                          className="col-sm-9 text-gray">{formatCourseDateLong(this.props.course.beginDate, this.props.course.endDate)} /<br/>{formatCourseDateLongEn(this.props.course.beginDate, this.props.course.endDate)}
                        </div>
                      </div>
                      {/*<div className="row">
        ...
        <RegisterSuccessDialog
          ...
          <div>
            ...
            <a className="btn btn-dark"
               ...
               href={`${HOST_BACKEND}/pages/print_dl_registration_form.php?trainee_id=${this.state.courseRegId}&payment=1&user=1`}
               target="_blank">
              พิมพ์ใบสมัคร / รายละเอียดการชำระเงิน
            </a>
          </div>
        </RegisterSuccessDialog>
